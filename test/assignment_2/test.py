...
class MyTestCase(unittest.TestCase):
    def test_spark_2(self):
        ...
        actual_input_total_lines = actual_data_lines
        expected_output_total_lines = count_lines(df)
        ...
        actual_input_lines_warn = actual_data_lines_warn
        expected_output_lines_warn = find_warn(df)
        ...
        actual_input_lines_api = actual_data_lines_api_client
        expected_output_lines_api = api_client(df)
        ...
        actual_input_lines_max = actual_data_lines_max_client
        expected_output_lines_max = client_request(data_split)
        ...
        actual_input_failed = actual_data_lines_id_failed
        expected_output_failed = failed_request(data_split)
        ...
        actual_input_most_active = actual_data_lines_repo
        expected_output_active = most_active_repo(data_split)
